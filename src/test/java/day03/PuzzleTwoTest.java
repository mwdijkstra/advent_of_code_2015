...
public class PuzzleTwoTest {
    ...
    public void getPuzzleAnswer() {
        ...
        int answer = puzzle.getHousesDelivered(input);
    ...
    @Test
    public void getHousesDeliveredTest() {

        PuzzleTwo puzzle = new PuzzleTwo();

        assertEquals(3, puzzle.getHousesDelivered("^v"));
        assertEquals(3, puzzle.getHousesDelivered("^>v<"));
        assertEquals(11, puzzle.getHousesDelivered("^v^v^v^v^v"));

    }

    @Test
    public void updateCurrentLocationTest() {

        PuzzleTwo puzzle = new PuzzleTwo();
        Location currentLocation = new Location(0, 0);

        puzzle.updateCurrentLocation(currentLocation, '^');
        assertThat(new Location(1, 0), samePropertyValuesAs(currentLocation));

        puzzle.updateCurrentLocation(currentLocation, '>');
        assertThat(new Location(1, 1), samePropertyValuesAs(currentLocation));

        puzzle.updateCurrentLocation(currentLocation, 'v');
        assertThat(new Location(0, 1), samePropertyValuesAs(currentLocation));

        puzzle.updateCurrentLocation(currentLocation, '<');
        assertThat(new Location(0, 0), samePropertyValuesAs(currentLocation));
